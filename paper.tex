...
\begin{document}
	...
	and \textit{ Resnet 50 }, determining small 7 x 7 kernels. By incorporating
	...
	images grow but also the number of dimensions increases.
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=0.5\linewidth]{imgs/methodology}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.8\linewidth]{imgs/resnet_arch.png}
	...
	\begin{wrapfigure}{r}{0.5\textwidth}
		\begin{center}
			\includegraphics[ width=0.45\textwidth ]{imgs/resnet_arch2.png}
		\end{center}
	...
	From this experiment/project we can clearly conclude that the ResNet 50
	outperforms other machine learning models.

	In the future, I would like to have algorithms which can automatically
	detect diseases, lesions and tumors, and highlight their locations in the
	large pile of images.

	I would also like to train using better machine learning models like GAN.
	...
	to generate new data with the same statistics as the training set.

	I also plan on improving and expanding the dataset, which will greatly
	increase our experimental results.
