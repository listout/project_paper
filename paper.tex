...
\begin{document}
	...
	\textbf{ Image Acquisition: } The MRI brain images are acquired and are given as input
	to pre-processing stage. The sample brain MR images are shown in figure 2.

	%\textbf{ Preprocessing: } Preprocessing is needed as it provides improvement  in  image
	%data  which    enhances  some  of  the  image  features  which  are
	%important  for  further  processing.  The    pre-processing  steps  that
	%are  applied  to  MR  image  are as follows :
